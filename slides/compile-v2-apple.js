...
const { renderAppleSlide } = require("./apple-common");
...
pres.title = "AI 是如何在前端开发流程中应用的 - Apple Style V2";
pres.lang = "zh-CN";
pres.theme = {
...
for (let i = 1; i <= 18; i += 1) {
  ...
  renderAppleSlide(pres, slideConfig);
}

async function main() {
  const output = path.join(__dirname, "output", "ai-frontend-sharing-v3-apple-v2.pptx");
