...
const { renderXaiSlide } = require("./xai-common");
...
pres.title = "AI 是如何在前端开发流程中应用的 - xAI Style";
pres.lang = "zh-CN";
pres.theme = {
...
for (let i = 1; i <= 18; i += 1) {
  ...
  renderXaiSlide(pres, slideConfig);
}

async function main() {
  const output = path.join(__dirname, "output", "ai-frontend-sharing-v4-xai.pptx");
